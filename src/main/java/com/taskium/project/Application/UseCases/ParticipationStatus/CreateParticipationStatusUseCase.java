...
@Service
public class CreateParticipationStatusUseCase {

    private final IParticipationStatusService participationStatusService;

    public CreateParticipationStatusUseCase(IParticipationStatusService participationStatusService) {
        this.participationStatusService = participationStatusService;
    }

    @Transactional
    public ParticipationStatusResponseDTO execute(ParticipationStatusRequestDTO dto) {
        return ParticipationStatusResponseDTO.from(participationStatusService.create(dto));
    }
}
